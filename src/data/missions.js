...
export const MISSIONS = [
  {
    key: "route", order: 1, title: "1단계 항로 복원실", icon: "🧭",
  ...
  {
    key: "geology", order: 2, title: "2단계 바위섬 분석실", icon: "⛰️",
  ...
  {
    key: "history", order: 3, title: "3단계 기록 보관소", icon: "📜",
  ...
  {
    key: "ecology", order: 4, title: "4단계 생태 수호 작전", icon: "🌿",
  ...
  {
    key: "briefing", order: 5, title: "5단계 브리핑 보드 제작", icon: "📌",
  ...
  {
    key: "presentation", order: 6, title: "최종 발표 준비", icon: "🎤",
...
export const BRIEFING_FIELDS = [
  ...
  { key: "ecology",    icon: "🌿", label: "생태", color: "#2f9e44" },
  { key: "protection", icon: "🛡️", label: "보호", color: "#d9480f" },
];
